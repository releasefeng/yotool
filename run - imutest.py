...
class MyWindow(QtGui.QMainWindow):
    ...
    def udpboxany(self,messlist):
        ...
        self.udpboxChild.batterybar.setProperty('value',int(messlist[1]))
    ...
    def otabidget(self):
        ...
        if currentstation == 'Board-C':
            ...
            bid='10'
        elif currentstation ==  u'直流电机1':
            bid='25'
        elif currentstation ==  u'直流电机2':
            bid='26'
        elif currentstation ==  u'电机广播升级':
            bid='20'
...
class titodebug(QtCore.QThread):
    ...
    def frameMessgeanaly(self,frame):
        #print(frame)
        fx=open('ui/accx.txt','a')
        fy=open('ui/accy.txt','a')
        fz=open('ui/accz.txt','a')
        fya=open('ui/imuyaw.txt','a')
        fan=open('ui/imufan.txt','a')
        fu=open('ui/imufu.txt','a')
...
class udpboxloop(QtCore.QThread):
    ...
    def run(self):
        ...
        f.close()
        udpboxwin.leftmotorvalue.setValue(20)
        udpboxwin.rightmotorvalue.setValue(20)
        while True:
