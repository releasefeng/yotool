...
# Form implementation generated from reading ui file 'cboard.ui'
#
...
class Cboard_Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout_9.addWidget(self.serialnum, 1, 1, 1, 1)
        ...
        self.boundrate.addItem(_fromUtf8(""))
        self.boundrate.addItem(_fromUtf8(""))
        self.gridLayout_9.addWidget(self.boundrate, 2, 1, 1, 1)
        ...
        self.gridLayout_9.addWidget(self.close, 5, 2, 1, 1)
        ...
        self.gridLayout_9.addWidget(self.serialset, 5, 1, 1, 1)
        ...
        item = QtGui.QListWidgetItem()
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/chaoshen.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item.setIcon(icon5)
        self.boardlist.addItem(item)
        item = QtGui.QListWidgetItem()
        item.setIcon(icon5)
        ...
        item = QtGui.QListWidgetItem()
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/battery.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item.setIcon(icon6)
        self.boardlist.addItem(item)
        item = QtGui.QListWidgetItem()
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/IR.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item.setIcon(icon7)
        self.boardlist.addItem(item)
        item = QtGui.QListWidgetItem()
        item.setIcon(icon7)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.boundrate.setItemText(1, _translate("Dialog", "9600", None))
        self.boundrate.setItemText(2, _translate("Dialog", "38400", None))
        self.boundrate.setItemText(3, _translate("Dialog", "115200", None))
        self.label_2.setText(_translate("Dialog", "串口号：", None))
        self.close.setText(_translate("Dialog", "关闭", None))
        self.serialset.setText(_translate("Dialog", "打开", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("Dialog", "B端串口", None))
        self.label_4.setText(_translate("Dialog", "暂未开发D端模拟", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("Dialog", "D端串口", None))
        ...
        item.setText(_translate("Dialog", "超声1", None))
        item = self.boardlist.item(10)
        item.setText(_translate("Dialog", "超声2", None))
        item = self.boardlist.item(11)
        item.setText(_translate("Dialog", "超声3", None))
        item = self.boardlist.item(12)
        item.setText(_translate("Dialog", "超声4", None))
        item = self.boardlist.item(13)
        item.setText(_translate("Dialog", "超声5", None))
        item = self.boardlist.item(14)
        item.setText(_translate("Dialog", "超声6", None))
        ...
        item = self.boardlist.item(26)
        item.setText(_translate("Dialog", "红外9", None))
        item = self.boardlist.item(27)
        item.setText(_translate("Dialog", "红外10", None))
        item = self.boardlist.item(28)
